...
nonisolated enum APIError: LocalizedError, Equatable, Sendable {
    ...
    var errorDescription: String? {
        ...
        case .invalidPairingPayload: "This QuickMail pairing code is not supported."
        case .invalidRequest: "The request could not be created."
        case .invalidResponse: "The server returned an invalid response."
        case .unauthorized: "Your QuickMail session is no longer valid."
        ...
        case .decoding: "QuickMail returned data this app could not read."
        }
    }
}
