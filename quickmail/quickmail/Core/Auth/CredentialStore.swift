...
actor CredentialStore {
    ...
    init(service: String = Bundle.main.bundleIdentifier ?? "QuickMail") {
...
nonisolated enum CredentialStoreError: LocalizedError, Sendable {
    ...
    var errorDescription: String? {
        switch self {
        case .keychain: "QuickMail could not access its secure credential storage."
        case .corruptCredential: "The saved QuickMail session was invalid and has been removed."
        }
    }
}
