...
- [x] Set the Xcode bundle identifier to `com.example.quickinbox` for Debug and
  Release.
- [ ] Register the matching explicit App ID `com.example.quickinbox` in the
...
- [ ] Register the explicit App ID `com.example.quickinbox` and use it in the App
